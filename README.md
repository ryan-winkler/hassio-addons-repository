...
| <img src="shelfarr/icon.png" width="150" height="150" /> | [Shelfarr](shelfarr/README.md) | shelfarr | 2026.08.31.1_6 | Self-hosted ebook and audiobook library manager (Shelfarr), using the upstream image with configurable audiobooks/ebooks/downloads paths. |
